...
import ReportesTributariosPage from './pages/ReportesTributariosPage'
...
const navigation = [
  ...
  { name: 'Protección Datos', href: '/proteccion-datos', icon: ShieldCheckIcon },
  { name: 'Reportes Tributarios', href: '/reportes-tributarios', icon: ClipboardDocumentCheckIcon },
]
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/proteccion-datos/*" element={<PrivateRoute><ProteccionDatosPage /></PrivateRoute>} />
      <Route path="/reportes-tributarios/*" element={<PrivateRoute><ReportesTributariosPage /></PrivateRoute>} />
